 ...
 * @author USER
 */
public class DeleteFoodMenuServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            boolean check = menu.deleteFoodInMenu(menuID, menuDate, foodID);
            ArrayList<MenuDetail> list = menu.getMenuDetail(menuID);
            if(check){
                request.setAttribute("AddResult", "Đã xóa món ăn");
                request.setAttribute("MenuDetail", list);
                request.getRequestDispatcher("MenuFoodDetail.jsp").forward(request, response);
            }else{
                request.setAttribute("AddResult", "Có lỗi trong quá trình xóa món ăn");
                request.setAttribute("MenuDetail", list);
                request.getRequestDispatcher("MenuFoodDetail.jsp").forward(request, response);
            }
